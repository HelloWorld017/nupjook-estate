...
/*
* Code from https://codepen.io/MillerTime/pen/XgpNwb
*/
// New Features
// ------------------
...
function colorSky(speed) {
	...
	canvasbg.style.backgroundColor = `rgb(${currentSkyColor.r | 0}, ${currentSkyColor.g | 0}, ${currentSkyColor.b | 0})`;
}
...
window.startfirework = () => soundManager.preload().then(init).catch(init);
startfirework();
